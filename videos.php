...
.1 Modify Blip.tv code by Capripot 16/03/08
.2 Change width/heigh for 16/9
...
define("WAT_WIDTH", 575); // default width
define("WAT_HEIGHT", 323); // default height
...
// blip.tv Code
define("BLIPTV_WIDTH", 575);
define("BLIPTV_HEIGHT", 323);
define("BLIPTV_REGEXP", "/\[bliptv ([[:print:]]+)\]/");
define("BLIPTV_TARGET", "<object type=\"application/x-shockwave-flash\" data=\"http://blip.tv/play/###URL###\" width=\"".BLIPTV_WIDTH."\" height=\"".BLIPTV_HEIGHT."\" wmode=\"transparent\"><param name=\"movie\" value=\"http://blip.tv/play/###URL###\" /></object>");
...
define("VIMEO_WIDTH", 575); // default width
define("VIMEO_HEIGHT", 323); // default height
define("VIMEO_REGEXP", "/\[vimeo ([[:print:]]+)\]/");
define("VIMEO_TARGET", "<object width=\"###WIDTH###\" height=\"###HEIGHT###\"><param name=\"allowfullscreen\" value=\"true\" /><param name=\"allowscriptaccess\" value=\"always\" /><param name=\"movie\" value=\"http://vimeo.com/moogaloop.swf?clip_id=###URL###&amp;server=vimeo.com&amp;show_title=1&amp;show_byline=0&amp;show_portrait=0&amp;color=ED8B1&amp;show_portrait=0&amp;color=00ADEF&amp;fullscreen=1\" /><embed src=\"http://vimeo.com/moogaloop.swf?clip_id=###URL###&amp;server=vimeo.com&amp;show_title=1&amp;show_byline=0&amp;show_portrait=0&amp;color=ED8B1&amp;show_portrait=0&amp;color=00ADEF&amp;fullscreen=1\" type=\"application/x-shockwave-flash\" allowfullscreen=\"true\" allowscriptaccess=\"always\" width=\"###WIDTH###\" height=\"###HEIGHT###\"></embed></object><br />");
...
define("DAILYMOTION_WIDTH", 575);
define("DAILYMOTION_HEIGHT", 323);
...
define("YOUTUBE_WIDTH", 575); // default width
define("YOUTUBE_HEIGHT", 323); // default height
define("YOUTUBE_REGEXP", "/\[youtube[:\s]([a-zA-Z0-9_-]+)([\s]([0-9]{1,2})m(([0-9]{2})s)?)?\]/");
define("YOUTUBE_TARGET", "<object width=\"###WIDTH###\" height=\"###HEIGHT###\"><param name=\"movie\" value=\"http://www.youtube.com/v/###URL###&fs=1&start=###T###\" /><param name=\"allowFullScreen\" value=\"true\" /><param name=\"allowscriptaccess\" value=\"always\" /><embed src=\"http://www.youtube.com/v/###URL###&fs=1&start=###T###\" type=\"application/x-shockwave-flash\" allowscriptaccess=\"always\" allowfullscreen=\"true\" width=\"###WIDTH###\" height=\"###HEIGHT###\"></embed></object>");
...
function youtube_plugin_callback($match)
{
	...
	if($match[4])
		$secs += $match[5];
	$output = str_replace("###T###", $secs, $output);
	if (count($tag_parts) > 2 && !$match[3]) {
		if ($tag_parts[2] == 0) {
